...
public class Constants {
    ...
    public final static int QUEUE_NUM = Integer.valueOf(System.getProperty("queue.num", "2"));
    public final static int TOPIC_NUM = Integer.valueOf(System.getProperty("topic.num", "3"));
}
