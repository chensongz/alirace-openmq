...
public class Constants {
    ...
    public final static int PRO_MAX = Integer.valueOf(System.getProperty("pro.max", "80000"));
    ...
    public final static int TOPIC_NUM = Integer.valueOf(System.getProperty("topic.num", "70"));
}
